...
body{
    height: 100vh;
    background: linear-gradient(140deg,rgb(20, 110, 170),rgba(7, 204, 155, 0.689));
    color: white;
}
form{
    ...
    border: 1px rgba(46, 46, 46, 0.299) solid;
}
.title{
    color: #ffffff;
    font-size: 35px;
            ...
            <div class="col-12 col-xl-11">
              <div class="mb-4 mb-md-5">
                ...
                <div>
                  ...
                  <address class="m-0 text-secondary"></address>
                </div>
              </div>
                ...
                <div class="col-12 col-sm-6">
                  <div class="mb-4 mb-sm-0">
                    ...
                    <div>
                      ...
                      <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="tel:+15057922430">03 37 65 77 66 </a>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-6">
                  <div class="mb-4 mb-sm-0">
                    ...
                    <div>
                      ...
                      <hr class="w-75 mb-3 border-dark-subtle">
                      <p class="mb-0">
                        <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">OurHealth@gmail.com</a>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div>
                  ...
                  <div class="d-flex mb-1">
                    <p class="text-secondary fw-bold mb-0 me-5">Sunday - Saturday</p>
